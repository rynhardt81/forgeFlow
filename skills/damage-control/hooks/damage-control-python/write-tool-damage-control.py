...
# ///
"""
Claude Forge Security Firewall - Write Tool Hook
=================================================

Protects files from being written based on path protection rules:
...
def check_file_path(file_path: str, config: Dict[str, Any]) -> tuple[bool, str]:
    """
    Check if a file path should be protected from writing.
